...
// Survlet 코드를 작성하기 위해서는 HttpServlet을 상속 받아야 한다
public class ServletEx2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		// req.getParameter() -> 여러 값 중 첫번째 값만 얻어옴(String)
		...
		// HTML 코드를 응답용 스트림을 이용해서 출력 -> HTML 코드로 해석돼서 보여짐
		// (HTML, CSS, JS 등 브라우저가 해석 할 수 있는 코드는 모두 해석되어 보여짐)
