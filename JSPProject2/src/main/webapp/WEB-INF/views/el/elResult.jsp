...
<body>
    ...
    <h4>추가 세팅된 값</h4>
    메시지 : <%=message %> <br>
    pesron의 name : <%= person.getName() %> <br>
    pesron의 age : <%= person.getAge() %> <br>
    pesron의 address : <%= person.getAddress() %> <br>
    ...
    <pre>
        ...
        --> empty가 null도 비어있다고 판단하고 있음
        
        * list3 : null은 아니지만 비어있음
        list3 eq null : ${list3 eq null}
        empty list3 : ${empty list3}
        
        list3에 요소가 추가되어있는가? ${!empty list3}
        list3에 요소가 추가되어있는가? ${not empty list3}
        ...
        * list4 : null도 아니고, 요소도 1개 추가 되어있음
        ...
        list4에 요소가 추가되어있는가? ${not empty list4}
