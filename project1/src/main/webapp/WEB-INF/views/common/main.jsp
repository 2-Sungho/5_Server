        ...
        <header>
            ...
            <section>
                <article class="search-area">
                    ...
                    <form action="#">
                        <fieldset>
                            <input type="text" id="query" name="query" placeholder="검색어를 입력해주세요" autocomplete="off">
                            <!-- 검색 버튼 -->
            ...
            <section class="content-2">
                <form action="#" name="login-frm">
                    ...
                    <fieldset id="id-pw-area">
                        <section>
                            <input type="text" name="inputId" placeholder="아이디" autocomplete="off"> <!-- autocomplete:자동완성 사용X -->
                    ...
                    <!-- label태그 내부에 input태그를 작성하면 자동 연결됨 -->
                    <label>
